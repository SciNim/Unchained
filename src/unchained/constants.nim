...
const
  ...
  c* = 299792458.0.`Meter*Second^-1`
  ## The vacuum permitivity / electric constant.
  ε_0* = 8.8541878128e-12.`A*s*V^-1*m^-1`
  ...
  k_B* = 1.380649e-23.`Joule*Kelvin^-1`
  ## Planck's constant
  hp* = 6.62607015e-34.`Joule*Hertz^-1`
  ...
  G_Newton* = 6.6743e-11.`N*m^2*kg^-2`
